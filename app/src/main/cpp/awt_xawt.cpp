...
JNIEXPORT void Java_java_awt_Font_initIDs(JNIEnv *env, jclass cls) {
...
JNIEXPORT jboolean JNICALL
Java_sun_awt_UNIXToolkit_gtkCheckVersionImpl(JNIEnv *env, jobject thiz, jint major, jint minor,
                                             jint micro) {
    return JNI_FALSE;
}
...
JNIEXPORT jboolean JNICALL
Java_sun_awt_UNIXToolkit_load_1gtk_1icon(JNIEnv *env, jobject thiz, jstring filename) {
    return JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_sun_awt_UNIXToolkit_load_1stock_1icon(JNIEnv *env, jobject thiz, jint widget_type,
                                           jstring stock_id, jint icon_size, jint text_direction,
                                           jstring detail) {
    return JNI_FALSE;
}

JNIEXPORT void JNICALL
Java_sun_awt_UNIXToolkit_nativeSync(JNIEnv *env, jobject thiz) {
